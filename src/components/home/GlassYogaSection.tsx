  ...
  return (
    <section className="py-20 bg-gradient-to-br from-purple-50 via-blue-50 to-teal-50 dark:from-gray-900 dark:via-purple-950 dark:to-gray-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-10 w-80 h-80 bg-blue-400/30 rounded-full blur-3xl animate-pulse delay-1000"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="group backdrop-blur-md bg-white/40 dark:bg-gray-800/40 border border-white/60 dark:border-gray-700/60 rounded-3xl p-8 hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:bg-white/60 dark:hover:bg-gray-800/60">
              <div className="w-14 h-14 mb-6 rounded-2xl bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="group backdrop-blur-md bg-white/40 dark:bg-gray-800/40 border border-white/60 dark:border-gray-700/60 rounded-3xl p-8 hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:bg-white/60 dark:hover:bg-gray-800/60">
              <div className="w-14 h-14 mb-6 rounded-2xl bg-gradient-to-br from-blue-500 to-teal-500 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="group backdrop-blur-md bg-white/40 dark:bg-gray-800/40 border border-white/60 dark:border-gray-700/60 rounded-3xl p-8 hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:bg-white/60 dark:hover:bg-gray-800/60">
              <div className="w-14 h-14 mb-6 rounded-2xl bg-gradient-to-br from-teal-500 to-purple-500 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Science Section */}
          <div className="backdrop-blur-md bg-white/30 dark:bg-gray-800/30 border border-white/40 dark:border-gray-700/40 rounded-3xl p-8 md:p-10 mb-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-purple-600 dark:text-teal-400 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="relative">
                <div className="aspect-square rounded-2xl backdrop-blur-md bg-white/20 dark:bg-gray-800/20 border border-white/40 dark:border-gray-700/40 flex items-center justify-center p-8">
          ...
          {/* CTA */}
          <div className="backdrop-blur-xl bg-white/20 dark:bg-gray-800/20 border border-white/40 rounded-3xl p-10 md:p-12 text-center shadow-2xl overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg md:text-xl mb-8 text-gray-700 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link 
                  ...
                  className="px-10 py-4 bg-gradient-to-r from-purple-600 to-teal-600 text-white rounded-full font-bold text-lg hover:from-purple-700 hover:to-teal-700 transition-all duration-300 hover:scale-105 shadow-xl"
                >
